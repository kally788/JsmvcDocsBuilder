...
if(typeof facade=="function"){window["$jsmvc$"].facade=facade.prototype=new $jsmvc$.core.FacadeAbs(loadRecord.html.name);window["$jsmvc$"].facade=facade=new facade();}else{alert(errMsg.err2);throw errMsg.err2;}}
